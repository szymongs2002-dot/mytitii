...
no.addEventListener("click", () => {
  if (count == 2) {
    ...
    text.innerHTML = "You meant to press YES, si amor ?😭";
    yes.style.height = "65%";
    yes.style.width = "60%";
    no.style.width = "30%";
    count++;
    ...
    text.innerHTML = "Your hand must have slipped right :c?🥹";
    yes.style.height = "70%";
    yes.style.width = "70%";
    no.style.width = "20%";
    count++;
    ...
    text.innerHTML = "Pretty Pweaasee🥺😘";
    yes.style.height = "90%";
    yes.style.width = "96%";
...
yes.addEventListener("click", () => {
  ...
  yes.innerHTML = '<a href="https://www.instagram.com/stvorek.st//">Text mee pweaseee, te extrano 🥹</a>';// inside the " " put your social media profile link
  yes.style.height = "90%";
  yes.style.width = "96%";
  no.style.display = "none";
  setTimeout(() => {
